...
class __TwigTemplate_ebd0822cde2a3f45ebdb4b4678a30ada extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_maintenance_form_general($context, array $blocks = [])
    {
      ...
      <h3 class=\"card-header\">
        ...
        ";
        // line 36
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Maintenance", [], "Admin.Global"), "html", null, true);
        echo "
      </h3>
      <div class=\"card-body\">
...
{% block content %}
  ...
  {% block maintenance_form_general %}
    <div class=\"card\">
      <h3 class=\"card-header\">
        <i class=\"material-icons\">business_center</i>
        {{ 'Maintenance'|trans({}, 'Admin.Global') }}
      </h3>
      <div class=\"card-body\">
        <div class=\"form-wrapper\">
...
{% endblock %}
", "@PrestaShop/Admin/Configure/ShopParameters/maintenance.html.twig", "/home/vagrant/code/prestashop8/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/maintenance.html.twig");
    }
}
