...
class __TwigTemplate_5fd5703ca2f21c7a1b83a62e3792363c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"helper-card__right\">
      ...
      <p>";
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Create roles for your employees with specific rights. SuperAdmin can access the entire store while other people can only be dedicated to the catalog or orders pages.", [], "Admin.Advparameters.Feature"), "html", null, true);
            echo "</p>
...
{% if not isShowcaseCardClosed %}
  <div id=\"employeesShowcaseCard\" class=\"showcase-card card\">
    ...
    <div class=\"helper-card__right\">
      ...
      <p>{{ 'Create roles for your employees with specific rights. SuperAdmin can access the entire store while other people can only be dedicated to the catalog or orders pages.'|trans({}, 'Admin.Advparameters.Feature') }}</p>
...
{% endif %}
", "@PrestaShop/Admin/Configure/AdvancedParameters/Employee/Blocks/showcase_card.html.twig", "/home/vagrant/code/prestashop8/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/Employee/Blocks/showcase_card.html.twig");
    }
}
