...
$this->privates['fragment.renderer.hinclude'] = $instance = new \Symfony\Component\HttpKernel\Fragment\HIncludeFragmentRenderer(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('W1vu336sa0mh92GgTjIIhJheWdwBK8AGuruscYx8VYdkfEvVYuZkQczbYwDjJVKa'))), NULL);
