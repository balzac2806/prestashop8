 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;qt((()=>{const t=new E("customer_thread");t.addExtension(new M),t.addExtension(new L),t.addExtension(new $),t.addExtension(new R),t.addExtension(new N),t.addExtension(new G),t.addExtension(new Bt),t.addExtension(new Pt),t.addExtension(new $t),t.addExtension(new Ft),t.addExtension(new Mt),t.addExtension(new zt),t.addExtension(new Nt(t))}))})(),window.customer_thread=o})();