 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class P{extend(t){t.getHeaderContainer().on("click",_,(()=>{window.location.reload()}))}}var $=n(9567),I=Object.defineProperty,z=Object.getOwnPropertySymbols,R=Object.prototype.hasOwnProperty,H=Object.prototype.propertyIsEnumerable,F=(t,e,n)=>e in t?I(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,N=(t,e)=>{for(var n in e||(e={}))R.call(e,n)&&F(t,n,e[n]);if(z)for(var n of z(e))H.call(e,n)&&F(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:It}=window;class zt{constructor(t){this.grid=t}extend(t){this.grid=t,this.addIdsToGridTableRows(),t.getContainer().find(s).tableDnD({onDragClass:k,dragHandle:a,onDrop:(t,e)=>this.handlePositionChange(e)}),t.getContainer().find(".js-drag-handle").on("mouseenter",(function(){It(this).closest("tr").addClass("hover")})).on("mouseleave",(function(){It(this).closest("tr").removeClass("hover")}))}handlePositionChange(t){const e=It(t).find(f(this.grid.getId())),n=e.data("update-url"),o=e.data("update-method"),i={positions:this.getRowsPositions()};this.updatePosition(n,i,o)}getRowsPositions(){const t=JSON.parse(It.tableDnD.jsonize())[`${this.grid.getId()}_grid_table`],e=[];let n;for(let o=0;o<t.length;o+=1)n=this.grid.getContainer().find(`#${t[o]}`),e.push({rowMarker:t[o],offset:n.data("dragAndDropOffset")});return this.computeMappingBetweenOldAndNewPositions(e)}addIdsToGridTableRows(){let t=0;this.grid.getContainer().find(u(this.grid.getId())).each(((e,n)=>{const o=It(n),i=`row_${o.data("id")}_${o.data("position")}`;o.closest("tr").attr("id",i),o.closest("td").addClass(l),o.closest("tr").data("dragAndDropOffset",t),t+=1}))}updatePosition(t,e,n){const o=["GET","POST"].includes(n),i=It("<form>",{action:t,method:o?n:"POST"}).appendTo("body"),r=e.positions.length;let s;for(let t=0;t<r;t+=1)s=e.positions[t],i.append(It("<input>",{type:"hidden",name:`positions[${t}][rowId]`,value:s.rowId}),It("<input>",{type:"hidden",name:`positions[${t}][oldPosition]`,value:s.oldPosition}),It("<input>",{type:"hidden",name:`positions[${t}][newPosition]`,value:s.newPosition}));o||i.append(It("<input>",{type:"hidden",name:"_method",value:n})),i.submit()}computeMappingBetweenOldAndNewPositions(t){var e;const n=new RegExp("^row_(?<rowId>\\d+)_(?<oldPosition>\\d+)$"),o=[];for(let i=0;i<t.length;i+=1){const r=n.exec(t[i].rowMarker);if(r&&!W(r.groups)&&!W(r.groups.rowId)&&!W(r.groups.oldPosition)){const t=parseInt(null==(e=null==r?void 0:r.groups)?void 0:e.oldPosition,10);o[i]={rowId:r.groups.rowId,oldPosition:t,newPosition:t}}for(let e=0;e<t.length;e+=1)W(t[e])||W(t[e].offset)||W(o[t[e].offset])||W(o[e])||(o[t[e].offset].newPosition=o[e].oldPosition)}return o}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rt}=window;Rt((()=>{const t=new T("feature");t.addExtension(new Et),t.addExtension(new P),t.addExtension(new A),t.addExtension(new L),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Tt),t.addExtension(new At),t.addExtension(new St),t.addExtension(new zt(t));new $t("featuresShowcaseCard").addExtension(new Lt)}))})(),window.feature=o})();