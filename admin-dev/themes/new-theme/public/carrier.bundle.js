(()=>{var t={3867:(t,e,n)=>{var o,i,r,s,a,l,c=n(9567);
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;class Rt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",a.linkRowAction,(t=>{const e=zt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const e=this.onClick;zt("tr",t.getContainer()).each((function(){const t=zt(this);zt(a.linkRowActionClickableFirst,t).each((function(){const n=zt(this),o=n.closest("td"),i=zt(a.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").on("mousedown",(()=>{zt(window).on("mousemove",(()=>{r=!0,zt(window).off("mousemove")}))})),i.on("mouseup",(()=>{const t=r;if(r=!1,zt(window).off("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(K(e)||K(n.get(0))?document.location.href=n.attr("href"):e(n.get(0)))}}))}))}))}}n(3867);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
