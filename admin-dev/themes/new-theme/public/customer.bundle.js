 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const Qt="#customerRequiredFieldsAlertMessageOptin",Ut='#customerRequiredFieldsContainer input[type="checkbox"][value="optin"]',{$:Vt}=window;Vt((()=>{const t=new C("customer");t.addExtension(new E),t.addExtension(new B),t.addExtension(new j),t.addExtension(new D),t.addExtension(new F),t.addExtension(new Bt),t.addExtension(new Tt),t.addExtension(new St),t.addExtension(new Dt),t.addExtension(new Ft),t.addExtension(new Rt),t.addExtension(new Wt);const e=new C("customer_discount");e.addExtension(new jt),e.addExtension(new St);const n=new C("customer_address");n.addExtension(new jt),n.addExtension(new D),n.addExtension(new St);const o=new C("customer_order");o.addExtension(new D),o.addExtension(new jt),o.addExtension(new St);const i=new C("customer_cart");i.addExtension(new D),i.addExtension(new jt),i.addExtension(new St);new C("customer_bought_product").addExtension(new D);new C("customer_viewed_product").addExtension(new D);new Ht("customersShowcaseCard").addExtension(new Nt),new Lt,new $,function(){var t,e,n,o,i,s,r,a,c;const d=new URL(document.URL).hash.slice(1);if(""===d)return;const l=document.getElementById(d);if(!l)return;let u=0;if(l.offsetParent){let t=l;do{u+=t.offsetTop,t=t.offsetParent?t.offsetParent:null}while(null!==t)}u-=null!=(n=null==(e=null==(t=document.querySelector("#header_infos"))?void 0:t.getBoundingClientRect())?void 0:e.height)?n:0,u-=null!=(s=null==(i=null==(o=document.querySelector(".header-toolbar"))?void 0:o.getBoundingClientRect())?void 0:i.height)?s:0,u-=null!=(c=null==(a=null==(r=document.querySelector(".card-header"))?void 0:r.getBoundingClientRect())?void 0:a.height)?c:0,u-=10,window.scroll(0,u)}(),Vt(Ut).on("click",(()=>{Vt(Qt).toggleClass("d-none",!Vt(Ut).is(":checked"))}))}))})(),window.customer=o})();