 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Jt}=window;Jt((()=>{const t=new j("cms_page_category");t.addExtension(new xt),t.addExtension(new Ot),t.addExtension(new Ct),t.addExtension(new S),t.addExtension(new jt),t.addExtension(new Lt),t.addExtension(new At),t.addExtension(new wt),t.addExtension(new Mt),t.addExtension(new Pt(t)),t.addExtension(new Wt);const e=new Nt;qt({sourceElementSelector:'input[name^="cms_page_category[name]"]',destinationElementSelector:`${e.localeInputSelector}:not(.d-none) input[name^="cms_page_category[friendly_url]"]`}),new Rt("#cms_page_category_parent_category");new Rt("#cms_page_category_shop_association").enableAutoCheckChildren(),new Ut({tokenFieldSelector:'input[name^="cms_page_category[meta_keywords]"]',options:{createTokensOnBlur:!0}});const n=new j("cms_page");n.addExtension(new xt),n.addExtension(new Ot),n.addExtension(new Ct),n.addExtension(new S),n.addExtension(new Mt),n.addExtension(new At),n.addExtension(new Lt),n.addExtension(new wt),n.addExtension(new Pt(n)),n.addExtension(new Wt),n.addExtension(new jt);new Yt("cms-pages-showcase-card").addExtension(new Xt)}))})(),window.cms_page=o})();