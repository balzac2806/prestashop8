 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;Lt((()=>{const t=new k("language");t.addExtension(new x),t.addExtension(new B),t.addExtension(new T),t.addExtension(new L),t.addExtension(new I),t.addExtension(new kt),t.addExtension(new Et),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new $t),new At("#language_shop_association").enableAutoCheckChildren()}))})(),window.language=o})();