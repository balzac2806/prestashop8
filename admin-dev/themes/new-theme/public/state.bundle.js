 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;class $t{constructor(){const t=new C("state");t.addExtension(new A),t.addExtension(new L),t.addExtension(new B),t.addExtension(new E),t.addExtension(new I),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new At),t.addExtension(new xt),t.addExtension(new St)}}Lt((()=>{new $t}))})(),window.state=o})();